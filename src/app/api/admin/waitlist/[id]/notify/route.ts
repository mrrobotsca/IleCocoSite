...
const BodySchema = z.object({
  branch: z.enum(['somerled', 'lachine']),
})

/**
 * Sends the "a spot is open" email to a single waitlist applicant and, on success,
 * marks them `offered` with a `notifiedAt` timestamp. Admin-only.
 */
