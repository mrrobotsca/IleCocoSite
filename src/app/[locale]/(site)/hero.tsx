...
import { BookButton, Eyebrow, WaitlistButton } from './ui'
  ...
  return (
    <section id='top' className='relative overflow-hidden bg-porcelain pb-20 pt-[130px]'>
      <Blob
        ...
        style={{ position: 'absolute', top: -80, right: -120, opacity: 0.4 }}
      />
      <Blob
        size={300}
        fill='var(--color-sandy-clay-soft)'
        style={{ position: 'absolute', bottom: -100, left: -80, opacity: 0.5 }}
      />
      ...
      <div className='relative mx-auto max-w-[1440px] px-8'>
        ...
        <div className='grid items-center gap-7 lg:grid-cols-[1fr_1.6fr_1fr]'>
          ...
          >
            ...
            <CocoTree
              ...
              style={{ position: 'absolute', bottom: -16, left: -20 }}
            />
          </motion.div>
          ...
          >
            ...
            <p className='mx-auto mt-7 max-w-[480px] text-[17px] leading-[1.6] text-ink-soft'>
              {c.lead}
            </p>
            ...
            <div className='mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row'>
              ...
              <BookButton variant='ghost'>{c.cta2}</BookButton>
            </div>
        ...
        >
          {[
            ...
            <div
              key={i}
              className={`px-2 text-center sm:px-4 ${i > 0 ? 'border-l border-charcoal-deep/10' : ''}`}
            >
              <div className='font-display text-[clamp(28px,4vw,44px)] font-bold leading-none text-charcoal-deep'>
                {s.v}
              </div>
          ...
          <Bloom
            size={32}
            color='var(--color-sunlit-clay)'
            style={{ position: 'absolute', top: -16, left: 'calc(33% - 8px)' }}
          />
        </motion.div>
      </div>
    </section>
