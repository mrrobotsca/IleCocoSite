    ...
    <section id='programs' className='relative mt-15'>
      ...
      <div className='relative overflow-hidden bg-ash-green pt-24 pb-28'>
        <CloudHen
          ...
          style={{ position: 'absolute', top: 50, right: '8%', opacity: 0.9 }}
        />
        <Squiggle
          width={240}
          height={50}
          style={{ position: 'absolute', bottom: 60, left: '5%', opacity: 0.5 }}
        />
        ...
        <div className='mx-auto grid max-w-[1280px] items-center gap-14 px-8 md:gap-20 lg:grid-cols-[1.1fr_1fr]'>
          ...
          >
            <div
              className='relative overflow-hidden rounded-[32px] shadow-[0_20px_60px_rgba(58,58,58,0.18)]'
          ...
          >
            ...
            <ul className='mt-8 grid grid-cols-1 gap-x-6 gap-y-3.5 sm:grid-cols-2'>
              {c.bullets.map((b, i) => (
                <li
                  key={i}
                  className='flex items-center gap-3 text-[15px] font-medium text-charcoal-deep'
                >
                  <span className='grid h-[22px] w-[22px] flex-shrink-0 place-items-center rounded-full bg-charcoal-deep text-[12px] text-porcelain'>
                    ✓
                  </span>
                  {b}
                </li>
            ...
            <BookButton variant='dark' withArrow className='mt-9'>
              {c.cta}
            </BookButton>
          </motion.div>
        </div>
