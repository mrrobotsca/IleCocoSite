  ...
  return (
    <section className="relative">
      ...
      <div className="relative overflow-hidden bg-sandy-clay-soft pb-28 pt-24">
        ...
        <Sparkle size={24} color="var(--color-charcoal-deep)" style={{ position: 'absolute', top: 160, right: '8%' }} />
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {c.items.map((t, i) => (
              ...
              >
                ...
                <p className="my-3 mb-6 font-italic-serif text-[17px] italic leading-[1.55] text-charcoal-deep">&ldquo;{t.quote}&rdquo;</p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-display text-[14px] font-bold text-charcoal-deep">{t.name}</div>
