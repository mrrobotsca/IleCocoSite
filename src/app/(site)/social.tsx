...
const TILES = [PHOTOS.social1, PHOTOS.social2, PHOTOS.social3, PHOTOS.social4, PHOTOS.social5, PHOTOS.social6]
...
export const Social = () => {
  ...
  return (
    <section className="relative overflow-hidden pb-20 pt-24">
      <StarBurst size={28} color="var(--color-charcoal-deep)" style={{ position: 'absolute', top: 80, right: '12%' }} />
      ...
      <div className="mx-auto max-w-[1280px] px-8">
        ...
        <div className="grid grid-cols-3 gap-3.5 md:grid-cols-6">
          {TILES.map((src, i) => (
            <motion.a
              key={i}
              href="https://instagram.com/ilecoco"
              target="_blank"
