...
export const Rocket = ({ size = 110, style, className }: DoodleProps) => (
  ...
  >
    <g fill='none' stroke={STROKE} strokeWidth='1.6' strokeLinecap='round' strokeLinejoin='round'>
      <path
        d='M50 12 C 62 18, 72 32, 70 56 L 56 78 C 50 80, 44 80, 38 78 L 24 56 C 22 32, 32 18, 44 12 C 46 10, 48 10, 50 12 Z'
        fill='#cfd8c4'
      />
...
export const CloudHen = ({ size = 130, style, className }: DoodleProps) => (
  ...
  >
    <g fill='none' stroke={STROKE} strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round'>
      <path
        d='M30 60 C 18 60, 12 50, 18 40 C 18 28, 30 22, 42 28 C 50 18, 70 18, 78 30 C 92 28, 102 38, 98 50 C 110 52, 112 64, 100 70 C 100 76, 90 80, 78 76 C 70 84, 50 84, 40 76 C 28 78, 22 70, 30 60 Z'
        fill='#faf8f2'
      />
...
export const Squiggle = ({
  ...
  <svg width={width} height={height} viewBox='0 0 280 60' style={style} aria-hidden='true'>
    <path
      d='M5 30 C 50 5, 90 55, 140 30 S 230 5, 275 30'
      fill='none'
      stroke={color}
      strokeWidth='1.6'
...
export const Blob = ({
  ...
  <svg width={size} height={size} viewBox='0 0 200 200' style={style} aria-hidden='true'>
    <path
      d='M40 80 C 30 50, 60 20, 100 25 C 145 30, 175 60, 170 105 C 165 150, 130 175, 85 170 C 45 165, 20 130, 30 100 C 32 92, 36 86, 40 80 Z'
      fill={fill}
    />
  </svg>
)
...
export const Spiral = ({ size = 50, color = STROKE, style }: DoodleProps) => (
  <svg width={size} height={size} viewBox='0 0 50 50' style={style} aria-hidden='true'>
    <path
      d='M25 25 C 27 23, 30 25, 28 28 C 25 32, 18 30, 18 23 C 18 13, 30 10, 36 18 C 44 28, 36 42, 22 42'
      fill='none'
      stroke={color}
      strokeWidth='1.5'
      strokeLinecap='round'
...
export const WaveDivider = ({
  ...
  >
    <path
      d='M0 30 C 120 0, 240 60, 360 30 S 600 0, 720 30 S 960 60, 1080 30 S 1320 0, 1440 30 L 1440 60 L 0 60 Z'
      fill={fill}
    />
  </svg>
)
...
export const QuoteMark = ({
  ...
  <svg width={size} height={size} viewBox='0 0 36 36' style={style} aria-hidden='true'>
    <path
      d='M8 22 C 6 12, 12 6, 18 6 L 18 12 C 14 12, 12 14, 12 18 L 16 18 L 16 26 L 8 26 Z M 22 22 C 20 12, 26 6, 32 6 L 32 12 C 28 12, 26 14, 26 18 L 30 18 L 30 26 L 22 26 Z'
      fill={color}
    />
  </svg>
)
...
export const HandUnderline = ({
  ...
  >
    <path
      d='M3 8 C 50 4, 100 11, 150 6 S 195 9, 197 7'
      fill='none'
      stroke={color}
      strokeWidth='3.5'
      strokeLinecap='round'
