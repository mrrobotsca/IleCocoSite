...
export const Gallery = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-porcelain py-24 lg:py-28">
      <Spiral size={42} color="var(--color-sandy-clay)" style={{ position: 'absolute', top: 60, right: '10%', opacity: 0.6 }} />
      ...
      <div className="mx-auto max-w-[1280px] px-8">
        ...
        >
          {PHOTOS_LIST.map((src, i) => (
            ...
            >
              <Image src={src} alt={c.captions[i]} fill sizes="(max-width: 640px) 50vw, 25vw" className="object-cover" />
